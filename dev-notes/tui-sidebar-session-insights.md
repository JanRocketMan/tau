...
The prompt editor keeps only its left border; focus, shell mode, active-run, and
error colors update that edge without surrounding the input on all four sides. Vertical
