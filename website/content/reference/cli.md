...
Tau does not check for updates or contact a package index at startup. After an
upgrade, the TUI adds a one-time message from its bundled release notes to the
transcript with the new features and fixes.
